...
#f (turtle.xcor() >= TARGET_LLEFT_X and
...
#if it goes below the target
if(turtle.xcor() < TARGET_LLEFT_X and turtle.ycor() >= TARGET_LLEFT_Y
   and turtle.xcor() < TARGET_LLEFT_X and turtle.ycor() <= TARGET_LLEFT_Y):
        print('You missed the target.')
        print('Try a lesser angle or a greater force')
